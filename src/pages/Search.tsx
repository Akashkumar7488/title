...
const Search = () => {
    ...
    const {data: hotelData} = useQuery(["searchHotels", searchParams], async() => {
    ...
    const handleHotelChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        event.target.checked
        ? [...prevStars, hotelType]
        : prevStars.filter((hotelTypes) => hotelTypes !== hotelType)
   );
    }
                ...
                <div className="flex justify-between items-center">
                    ...
                    <select value={sortOption} onChange={(event) => setSortOption(event.target.value)}
                        className="p-2 border rounded-md">
                            ...
                            <option value="pricePerNIghtAsc">Price Per Night (high to low)</option>
