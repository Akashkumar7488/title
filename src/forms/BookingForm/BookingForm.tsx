    ...
    return (
        <>
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-5">
            <span className="text-3xl font-bold">Confirm Your Email</span>
            <div className="grid grid-cols-2 gap-6">
                {/* <label className="text-gray-700 text-sm font-bold flex-1">
                    Name
                  <input className="mt-1 rounded w-full p-2 px-3 text-gray-700 bg-gray-200 font-normal"
                  type="text"
                  readOnly
                  disabled
                  {...register("Name")}
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-semibold">Your Price Sumary</h2>
